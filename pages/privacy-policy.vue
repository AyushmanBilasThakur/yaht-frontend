<template>
    ...
    <div class="flex justify-center items-center py-24 mb-4 bg-slate-300">
        <p class="text-4xl">Privacy Policy</p>
    </div>

    <div class="px-5 max-w-[1020px] w-[90%] mx-auto">
        <p>
        Yet Another Developer built the Yet Another Habit Tracker app as
        a Free app. This SERVICE is provided by
        Yet Another Developer at no cost and is intended for use as
        is.
        </p> <p>
        ...
        Yet Another Habit Tracker unless otherwise defined in this Privacy Policy.
        </p> 
        ...
        this page.
    </p> <p>This policy is effective as of 2022-02-21</p> <p ><strong>Contact Us</strong></p> <p class="mb-5">
        If you have any questions or suggestions about our
        Privacy Policy, do not hesitate to contact us at ayushmanbilasthakur@gmail.com.
    </p>
    </div>
</template>
